...
public class GyroController : MonoBehaviour 
{
	...
	{
		AttachGyro();
		startRotation = Quaternion.Slerp(transform.rotation,
	...
	protected void Update() 
	{
		if (!gyroEnabled)
			return;
		Quaternion preRotation = Quaternion.Slerp(transform.rotation,
		                               cameraBase * ( ConvertRotation(referanceRotation * Input.gyro.attitude) * GetRotFix()),
		                               lowPassFilterFactor);
		transform.rotation = new Quaternion(preRotation.x - startRotation.x, preRotation.y, preRotation.z, preRotation.w);
	}
